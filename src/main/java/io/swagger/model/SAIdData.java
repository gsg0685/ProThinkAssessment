...
public class SAIdData {
    ...
    public SAIdData( boolean valid,  String idNumber,  LocalDate dateOfBirth,  Gender gender,
    ...
    public static class Builder {
        ...
        public SAIdData build() {
            return new SAIdData(valid, idNumber, dateOfBirth, gender, citizenshipStatus);
        }
    }
}